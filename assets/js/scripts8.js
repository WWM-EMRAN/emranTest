...
(function () {
    ...
    function initNavigationBehavior() {
        ...
        const runScrollSpy = () => {
            ...
            // const position = window.scrollY + (headerOffset + 50);
        ...
        // const runScrollSpy = () => {
        //     const position = window.scrollY + (headerOffset + 20); // Adjusted offset for precision
        //     let activeSectionId = null;
        //
        //     // 1. Identify the most relevant section in view
        //     navLinks.forEach(link => {
        //         if (!link.hash || link.hash === '#' || link.hash === '#all-cv-wrapper') return;
        //         const section = document.querySelector(link.hash);
        //
        //         if (section && position >= section.offsetTop && position <= (section.offsetTop + section.offsetHeight)) {
        //             // Pick the section that is further down the page (more specific)
        //             activeSectionId = link.hash;
        //         }
        //     });
        //
        //     // 2. Fallback to Home if at the top
        //     if (!activeSectionId && position < 500) {
        //         activeSectionId = document.querySelector('#navmenu a[href="#hero"]') ? '#hero' : '#all-cv-wrapper';
        //     }
        //
        //     // 3. Only update DOM if the active section has changed
        //     if (activeSectionId) {
        //         const activeLink = document.querySelector(`#navmenu a[href="${activeSectionId}"]`);
        //
        ...
        //             });
        //
        //             // Apply classes to the link and its parent LI
        ...
        //             }
        //
        //             // Sync the Dynamic Sticky Header
        //             const cleanId = activeSectionId.replace('#', '');
        //             if (typeof SiteSection !== 'undefined' && SiteSection.render_sticky_header) {
        //                 SiteSection.render_sticky_header(cleanId);
        //             }
        //         }
        //     }
        // };
